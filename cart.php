         ...
         while($row_product_price=mysqli_fetch_array($result_products)){
          ...
          $total_price+=$product_values;
                ...
                <tr>
                    ...
                    <td><img src="./admin-area/product_images/<?php echo $product_image1?>" alt="" width=100px></td>
                    ...
                    <td>
                        ...
                        <input type="submit" name="update_cart" class="bg-success px-3 py-2 border-0 mx-3" value="Update cart">
                       <!-- <button class="bg-success px-3 py-2 border-0 mx-3">Remove</button>--->
                       <input type="submit" name="remove_cart" class="bg-success px-3 py-2 border-0 mx-3" value="Remove cart">
...
if($result_count>0){
  ...
  <input type='submit' name='Continue_Shopping' class='bg-success px-3 py-2 border-0 mx-3' value='Continue Shopping'>
  <button  class='bg-secondary'  px-3 py-2 border-0'><a href='./user_area/checkout.php' class=''>Checkout</button></a>
";
}else{
  echo "<input type='submit' name='Continue_Shopping' class='bg-success px-3 py-2 border-0 mx-3' value='Continue Shopping'>
  ";
}
