        ...
        <div class="row d-flex align-items-center justify-content-center">
            <div class="col-lg-12 col-xl-6">
                <form action="" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="mt-4 pt-2">
                        <input type="submit" value="Register" class="bg-success 
                        py-2 px-3 border-light" name="user_register">
                        <p class="small font-weight-bold mt-2 pt-1 mb-0">Already have an account? <a href="user_login.php" class="text-danger"> Login</a> </p>
                    </div>
                </form>
            </div>
        </div>
...
$insert_query="insert into `user_table` (user_username, user_password,user_email,
user_image,user_ip,user_address,user_mobile)values('$user_username','$hash_password','$user_email',
