  ...
  if(!isset($_GET['brand'])){
    ...
    $select_query="Select * from `products` order by rand() LIMIT 0,6 ";
       ...
       while($row=mysqli_fetch_assoc($result_query)){
        ...
        <div class='card'>
        <img src='./admin-area/product_images/$product_image1' 
  ...
  if(!isset($_GET['brand'])){
    ...
    $select_query="Select * from `products` order by rand()";
       ...
       while($row=mysqli_fetch_assoc($result_query)){
        ...
        class='card-img-top' alt='$product_title'>
        <div class='card-body'>
         <h5 class='card-t itle'>$product_title</h5>
         <p class='card-text'>$product_description</p>
...
//displaying categories in didenav
...
$product_id=$_GET['product_id'];
    ...
    <div class='row'>
        <div class='col-md-12'>
            <h4 class='text-center text-success mb-5'>Releated 
                products</h4>
        </div>
        <div class='col-md-6'>
                ...
                if(!isset($_GET['edit_account'])){
                  if(!isset($_GET['my_orders'])){
                    if(!isset($_GET['delete_account'])){
                      $get_orders="Select * from `users_order` where user_id=$user_id 
                      and order_status='pending'";
                      $result_orders_query=mysqli_query($con,$get_orders);
                      $row_count=mysqli_num_rows($result_orders_query);
                      if($row_count>0){
                        echo "<h3 class='text-center text-info'> You have<span 
